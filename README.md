...
[Hub 地址](https://hub.docker.com/repository/docker/ZhangWenTao94/chatgpt-web/general)
...
services:
  app:
    image: ZhangWenTao94/chatgpt-web # 总是使用 latest ,更新时重新 pull 该 tag 镜像即可
    ports:
      - 127.0.0.1:3002:3002
    environment:
      # 二选一
